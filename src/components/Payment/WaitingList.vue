<template>
	...
	<div>
		...
		<el-table :data="tableData" border style="width: 100%">
			...
			<el-table-column prop="documenttype" label="来源单类型" width="100">
			</el-table-column>
			<el-table-column prop="documentstatus" label="来源单据状态" width="100">
			</el-table-column>
			...
			<el-table-column prop="carmagid" label="车牌号/车架号" width="100">
			</el-table-column>
...
<script>
	...
	export default {
		...
		methods: {
			...
			findNameAndId() {
				const _this = this
				this.axios.get("http://localhost:8081/asms/findduein", {
