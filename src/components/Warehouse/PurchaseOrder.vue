		...
		<el-tabs type="border-card">
			...
			<div>
				<el-table :data="tableData" height="300"  border style="width: 100%;font-size: 13px;" empty-text="暂无数据">
					...
					<el-table-column prop="djlx" label="采购单号" show-overflow-tooltip></el-table-column>
					<el-table-column prop="djlx" label="订货时间" show-overflow-tooltip></el-table-column>
					<el-table-column prop="djlx" label="审核状态" show-overflow-tooltip></el-table-column>
					<el-table-column prop="djlx" label="入库状态" show-overflow-tooltip></el-table-column>
					<el-table-column prop="djlx" label="采购种类" show-overflow-tooltip></el-table-column>
					<el-table-column prop="djlx" label="含税金额" show-overflow-tooltip></el-table-column>
					<el-table-column prop="bh" label="供应商" show-overflow-tooltip>
					</el-table-column>
					<el-table-column prop="mll" label="联系人" show-overflow-tooltip>
					</el-table-column>
					<el-table-column prop="kdrq" label="联系电话" show-overflow-tooltip></el-table-column>
					<el-table-column prop="djlx" label="预到货时间" show-overflow-tooltip></el-table-column>
					<el-table-column prop="khhy" label="经手人" show-overflow-tooltip>
					</el-table-column>
