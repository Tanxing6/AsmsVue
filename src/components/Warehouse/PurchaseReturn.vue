		...
		<el-tabs type="border-card">
			...
			<div>
				<el-table :data="tableData" border style="width: 100%;text-align: center;">
					...
					<el-table-column prop="djlx" label="退货单号" show-overflow-tooltip></el-table-column>
					<el-table-column prop="khhy" label="单据状态" show-overflow-tooltip>
					</el-table-column>
					<el-table-column prop="bh" label="供应商" show-overflow-tooltip>
					</el-table-column>
					<el-table-column prop="spmc" label="退货金额" show-overflow-tooltip>
					</el-table-column>
					<el-table-column prop="mll" label="经手人" show-overflow-tooltip>
					</el-table-column>
					<el-table-column prop="kdrq" label="创建时间" show-overflow-tooltip></el-table-column>
					<el-table-column prop="djlx" label="申请单号" show-overflow-tooltip></el-table-column>
					<el-table-column prop="khhy" label="入库单号" show-overflow-tooltip>
					</el-table-column>
		...
		<el-form :model="form" label-width="90px;" style="width: 100%;">
			...
			<div>
				<el-table :data="tableData" :row-class-name="rowClassName" show-summary border style="width: 100%;text-align: center;">
					...
					<el-table-column prop="unitprice" label="退货单价" show-overflow-tooltip></el-table-column>
