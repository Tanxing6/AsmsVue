<template>
		...
		<el-tabs type="border-card">
			...
			<div>
				<el-table :data="tableData" border style="width: 100%;text-align: center;">
					...
					<el-table-column prop="djlx" label="出库单号" show-overflow-tooltip></el-table-column>
					<el-table-column prop="khhy" label="单据状态" show-overflow-tooltip>
					</el-table-column>
					<el-table-column prop="bh" label="维修单号" show-overflow-tooltip>
					</el-table-column>
					<el-table-column prop="mll" label="送修人" show-overflow-tooltip></el-table-column>
					<el-table-column prop="mll" label="车牌号" show-overflow-tooltip></el-table-column>
					<el-table-column prop="mll" label="车辆品牌" show-overflow-tooltip></el-table-column>
					<el-table-column prop="mll" label="联系电话" show-overflow-tooltip></el-table-column>
					<el-table-column prop="mll" label="领料人" show-overflow-tooltip></el-table-column>
					<el-table-column prop="kdrq" label="领料日期" show-overflow-tooltip></el-table-column>
	...
	<el-dialog title="维修领料出库单" v-model="add" width="88%">
		...
		<el-form :model="form" label-width="90px;" style="width: 100%;">
			...
			<el-row style="margin-bottom: 20px;margin-top: 20px;">材料明细</el-row>
			<div>
				<el-table :data="tableData" :row-class-name="rowClassName" show-summary border style="width: 100%;text-align: center;">
					...
					<el-table-column prop="backnumber" label="领用数量" show-overflow-tooltip></el-table-column>
					<el-table-column prop="unitprice" label="领用单价" show-overflow-tooltip></el-table-column>
					<el-table-column prop="khhy" label="折扣(%)" show-overflow-tooltip></el-table-column>
					<el-table-column prop="khhy" label="领用金额" show-overflow-tooltip></el-table-column>
