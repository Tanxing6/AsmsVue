<template>
	...
	<div style="border: 1px solid skyblue;height: 40px;">
		...
		<div style="float: left;margin-top: 4px;">
			...
			<el-select v-model="pageInfo.branchnames" placeholder="客户级别" id="select1" size="small" @change="suoshufd">
				<el-option >所有门店</el-option>
				<el-option v-for="item in suptype" :key="item.branchid" :label="item.branchname" :value="item.branchname">
				</el-option>
			</el-select>
			<el-select v-model="pageInfo.branchnames" placeholder="客户类别" id="select1" size="small" @change="suoshufd">
				<el-option >所有门店</el-option>
				<el-option v-for="item in suptype" :key="item.branchid" :label="item.branchname" :value="item.branchname">
				</el-option>
			</el-select>
			<el-select v-model="pageInfo.branchnames" placeholder="销售顾问" id="select1" size="small" @change="suoshufd">
				<el-option >所有门店</el-option>
				<el-option v-for="item in suptype" :key="item.branchid" :label="item.branchname" :value="item.branchname">
				</el-option>
			</el-select>
	 ...
	 @selection-change="handleSelectionChange" border type="index">
		...
		<el-table-column prop="" label="操作" show-overflow-tooltip>
			<template #default="scope">
				...
				<el-button  v-model="ismoren1" >查看消费记录</el-button>
		...
		<el-table-column prop="" label="性别" show-overflow-tooltip>
		</el-table-column>
		<el-table-column prop="" label="联系人" show-overflow-tooltip>
		</el-table-column>
		<el-table-column prop="" label="客户类型"  show-overflow-tooltip>
		</el-table-column>
		<el-table-column prop="" label="客户级别" show-overflow-tooltip>
		</el-table-column>
		<el-table-column prop="" label="储值卡号" show-overflow-tooltip>
		</el-table-column>
		<el-table-column prop="" label="车辆数" show-overflow-tooltip>
		</el-table-column>
		<el-table-column prop="" label="销售顾问" show-overflow-tooltip>	
		</el-table-column>
		<el-table-column prop="" label="备注" show-overflow-tooltip>
		</el-table-column>
		<el-table-column prop="" label="注册时间" show-overflow-tooltip>
		</el-table-column>
	</el-table>
	...
	<el-dialog title="基本信息" v-model="addshop">
		<el-form :model="supplierform" label-width="90px" style="width: 540px;">
					<el-form-item label="客户名称" :label-width="formLabelWidth">
						<el-input v-model="supplierform.suppliername" size="small"></el-input>
					</el-form-item>
					<el-row span="2" :gutter="20">
						<el-col span="2">
							...
							<el-form-item label="联系人" :label-width="formLabelWidth">
								<el-input v-model="supplierform.contacts" size="small"></el-input>
							</el-form-item>
							<el-form-item label="联系电话" :label-width="formLabelWidth">
