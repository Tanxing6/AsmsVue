<template>
	...
	<el-table ref="supplierform" :data="tableData" highlight-current-row @current-change="handleCurrentChange2"
	 tooltip-effect="dark" style="width: 100%;" @selection-change="handleSelectionChange" border type="index">
		...
		<el-table-column prop="" label="车牌号" show-overflow-tooltip>
		</el-table-column>
		...
		<el-table-column prop="" label="年检到期日" show-overflow-tooltip>
		</el-table-column>
		<el-table-column prop="" label="下次保养时间" show-overflow-tooltip>
		</el-table-column>
		<el-table-column prop="" label="下次保养里程" show-overflow-tooltip>
		</el-table-column>
	...
	<el-dialog title="基本信息" v-model="addshop">
		<el-form :model="supplierform" label-width="100px" style="width: 640px;">
			...
			<el-row span="2">
				...
				<el-col span="3">
					...
					<el-form-item label="是否本店购买" :label-width="formLabelWidth">
						<el-select v-model="companyid" placeholder="请选择" id="select1" size="small" @change="suoshufd">
